...
> - **LLM Training & Inference Infrastructure:** DeepSpeed, Megatron-LM, SGLang, vLLM, TensorRT-LLM, distributed training, tensor/pipeline parallelism, continuous batching, KV cache optimization, quantization, and API serving
